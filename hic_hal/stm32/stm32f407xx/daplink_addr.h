...
#define DAPLINK_RAM_SIZE                0x00014000
...
#define DAPLINK_ROM_CONFIG_ADMIN_START  0x0800C000
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00004000

#define DAPLINK_ROM_IF_START            0x08010000
#define DAPLINK_ROM_IF_SIZE             0x00010000

#define DAPLINK_ROM_CONFIG_USER_START   0x08020000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00020000

/* RAM sizes */

#define DAPLINK_RAM_APP_START           0x20000000
#define DAPLINK_RAM_APP_SIZE            0x00013F00

#define DAPLINK_RAM_SHARED_START        0x20013F00
